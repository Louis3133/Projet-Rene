...
ActiveRecord::Schema[8.0].define(version: 2025_01_08_114204) do
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.integer "emoji1_id", null: false
    t.integer "emoji2_id", null: false
    t.integer "emoji3_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "questions", "emoji1s"
  add_foreign_key "questions", "emoji2s"
  add_foreign_key "questions", "emoji3s"
